...
Join us at one of our next meetups to find out more
...
We are a non-profit organization, which is completely run by volunteers. If you want to become a member and support us on a regular basis, you can [become a member](https://wiki.munichmakerlab.de/wiki/Become_a_Member), 
and bring it to one of our meetings or send it via mail or e-mail (details on the form). However, being a member is not a prerequisite to use the space, so feel free to just stop by.
