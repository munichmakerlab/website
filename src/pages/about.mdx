...
We are a non-profit organization, which is completely run by volunteers. If you want to become a member and support us on a regular basis, you just need to fill [out our membersip form](https://wiki.munichmakerlab.de/wiki/Become_a_Member), 
and send it via e-mail (details on the form), bring it to the Munich Maker Lab or send it by mail. However, being a member is not a prerequisite to use the space, so feel free to just stop by.
For more details about the onboarding process check our wiki page [Onboarding](https://wiki.munichmakerlab.de/wiki/Onboarding).

Being a member has some benefits, such as the possibility to get a key to the space. 

Here are also more details about our [Our statutes](statutes)  and [Our scale of fees](scaleoffees)
