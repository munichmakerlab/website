...
For more details, see our <a href={getRelativeLocaleUrl('en', 'join')}>join page</a>, <a href={getRelativeLocaleUrl('en', 'statutes')}>statutes</a> and <a href={getRelativeLocaleUrl('en', 'scaleoffees')}>scale of fees</a>.
...
3D Printing · CNC Routing · Laser Cutting · Electronics · Programming · Digital Media · Woodworking · Metalworking · Welding · Plastics · Textiles · Screenprinting · Tiffany Glass Art · Bicycle Repair · Food · Pinball · Hacking · DIY · Repair · Art · 
