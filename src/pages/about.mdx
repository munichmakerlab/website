...
Everyone is welcome to visit when our website indicates an [open status](https://status.munichmakerlab.de/), as we don't have fixed opening times apart from our open Thursday. We are a fully community-driven space, and no one is paid for their contributions to the lab. 
