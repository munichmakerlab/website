...
> This English translation is provided for convenience only and is not legally binding. The legally binding version is the <a href={getRelativeLocaleUrl('de', 'statutes')}>German original</a>.
