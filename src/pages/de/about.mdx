...
Weitere Details findest du in unserer <a href={getRelativeLocaleUrl('de', 'statutes')}>Satzung</a>.
...
Weitere Details findest du auf unserer <a href={getRelativeLocaleUrl('de', 'join')}>Mitmach-Seite</a>, in unserer <a href={getRelativeLocaleUrl('de', 'statutes')}>Satzung</a> und unserer <a href={getRelativeLocaleUrl('de', 'scaleoffees')}>Beitragsordnung</a>.
...
3D-Druck · CNC-Fräse · Laserschneiden · Elektronik · Programmieren · Digitale Medien · Holzbearbeitung · Metallbearbeitung · Schweißen · Kunststoff · Textil · Siebdruck · Tiffany-Glaskunst · Fahrrad · Lebensmittel · Flipper · Hacking · DIY · Reparatur · Kunst
