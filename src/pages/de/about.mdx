...
<div class="workshop-tags">
  {['3D-Druck', 'CNC-Fräse', 'Laserschneiden', 'Elektronik', 'Programmieren',
    'Digitale Medien', 'Holzbearbeitung', 'Metallbearbeitung', 'Schweißen', 'Kunststoff',
    'Textil', 'Siebdruck', 'Tiffany-Glaskunst', 'Fahrrad', 'Lebensmittel',
    'Flipper', 'Hacking', 'DIY', 'Reparatur', 'Kunst'].map(tag => (
